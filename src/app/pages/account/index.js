...
import { Avatar, Button, Col, Dropdown, Layout, Menu, Row, Spin, Tooltip, Typography } from 'antd'
import { LOCAL_STORAGE_KEY, MSG } from 'app/consts'
import coin from 'app/consts/coin'
import { AddCoin, CreateAccount, ImportAccount } from 'app/pages/account/components'
...
import { loadingClose, loadingCloseAction, loadingOpen, loadingOpenAction } from 'app/redux/common/actions'
import {
...
import { CaretDownOutlined, CheckOutlined, CopyOutlined, DownloadOutlined, PlusOutlined } from '@ant-design/icons'

import { AccountKeyButton } from './components/AccountKeyPopup'
      ...
      <div className="wrap">
        <Layout className="full-width">
          <Sider className="account-sidebar bg-white" width={400}>
            <Row>
              <AccountBackupKeyStyled>
                <AccountKeyButton accountName={getName(accountSelected?.name)} />
              </AccountBackupKeyStyled>
